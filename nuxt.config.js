...
module.exports = {
  ...
  head: {
    ...
    meta: [
      ...
      },
      {
        name: 'description',
        content:
          'にしだけ夫婦がオーストラリアでのバンライフ（車中泊）生活や、旅やリモートワークなどを通じて、楽しく生きるためのいろんな価値観を模索していくブログです。',
        hid: 'description'
      },
      {
        name: 'google-site-verification',
        content: 'XGQ71tOVna37NmkZkbVjdcnKvS8q8-H0khYZ3koGuo4'
      },
      {
      ...
      {
        name: 'twitter:image',
        content: 'https://nishida.lol/ogp.jpg'
      },
  ...
  css: ['normalize.css/normalize.css', '~/assets/style/app.styl'],
  /*
